...
export declare const GridColumns: {
    ...
    readonly 6: "grid-cols-6";
    readonly 7: "grid-cols-7";
    readonly 8: "grid-cols-8";
    readonly 9: "grid-cols-9";
    readonly 10: "grid-cols-10";
    readonly 11: "grid-cols-11";
    readonly 12: "grid-cols-12";
    readonly None: "grid-cols-none";
};
